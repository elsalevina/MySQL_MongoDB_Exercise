...
''' MAKE A DATABASE ON MONGODB '''
import pymongo
urldb = "mongodb://127.0.0.1:27017"
mymongo = pymongo.MongoClient(urldb)

# make a new database
mydb = mymongo['digimon']    

# make a collection
digi = mydb['digimon']

# send data into database 'digimon', collection 'digimon'
send = digi.insert_many(datadigimon)
